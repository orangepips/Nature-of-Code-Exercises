...
class Vehicle {
  ...
  void follow(Path p) {
    ...
    for (int i = 0; i < p.points.size(); i++) {
      ...
      PVector b = p.points.get(i == p.points.size() - 1 ? 0 : i+1);
      ...
      if (normalPoint.x < displacement || normalPoint.x > width - displacement || normalPoint.y < displacement || normalPoint.y > height - displacement) {
        normalPoint = b.get(); 
      }
